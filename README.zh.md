...
- **文件搜索** — 支持通配符和正则表达式搜索
- **文件提取** — 支持保留目录结构批量导出
- **高级图片查看器** — 支持 BLP（War3/WoW）和 DDS（SC2）纹理的 MIP 贴图切换和动画播放
...
- **图片格式**：支持 BLP2 原始纹理和 DDS DXT1/3/5 纹理。BLP1 和 BLP2 JPEG 压缩纹理尚未支持。

## 注意事项

- **只读工具**：本工具不会以任何方式修改 CASC 存储
- **在线 CDN**：按需下载和缓存游戏数据分块
- **图片查看器**：支持 BLP2 原始纹理和 DDS DXT1/3/5 纹理。BLP1 和 BLP2 JPEG 压缩纹理尚未支持。
